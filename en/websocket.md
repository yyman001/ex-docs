...
| ----- | ---------------------------- | ------------------------------------- |
| req   | market\_$symbol_kline_1month | Request 1 month historical bar record |
| sub   | market\_$symbol_depth_step0  | Subscribe depth                       |
| sub   | market\_$symbol_kline_1min   | Subscribe to 1min k-line information  |
| sub   | market\_$symbol_ticker       | Subscribe to 24h market data          |
| sub   | market\_$symbol_trade_ticker | Subscribe to real-time trade          |
| unsub | market\_$symbol_depth_step0  | Unsubscribe depth                     |
| unsub | market\_$symbol_ticker       | Unsubscribe 24h market data           |
| unsub | market\_$symbol_trade_ticker | Unsubscribe real-time trade           |
